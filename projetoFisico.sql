...
(
    id integer NOT NULL,
    obra_manga_fk integer NOT NULL,
    editor_fk integer NOT NULL,
    CONSTRAINT "editor_obraMangaEdita_pkey" PRIMARY KEY (id),
    CONSTRAINT "editor_obraMangaEdita_editor_fk_fkey" FOREIGN KEY (editor_fk)
        REFERENCES public.editor (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT "editor_obraMangaEdita_obra_manga_fk_fkey" FOREIGN KEY (obra_manga_fk)
        REFERENCES public.obra_manga (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
-- Table: public.editor_chefe

-- DROP TABLE IF EXISTS public.editor_chefe;

CREATE TABLE IF NOT EXISTS public.editor_chefe
(
    id integer NOT NULL,
    func_editora_fk integer NOT NULL,
    CONSTRAINT editor_chefe_pkey PRIMARY KEY (id),
    CONSTRAINT editor_chefe_func_editora_fk_fkey FOREIGN KEY (func_editora_fk)
        REFERENCES public.func_editora (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
...
ALTER TABLE IF EXISTS public.editor_chefe
    OWNER to postgres;
...
(
    ...
    avali_desemp character varying COLLATE pg_catalog."default",
    CONSTRAINT editor_pkey PRIMARY KEY (id),
    CONSTRAINT editor_func_editora_fk_fkey FOREIGN KEY (func_editora_fk)
        REFERENCES public.func_editora (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
